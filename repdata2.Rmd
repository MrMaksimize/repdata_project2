...
yscale <- c(0, mean(both_above_mean$DMG_TOT + sd(both_above_mean$DMG_TOT)))
...
geom_bar(stat = "identity", position="stack", aes(y=H_IMP, fill=HE)) + 
##scale_fill_discrete(name = "Economic Damage Type") + 
facet_wrap(~ EVTYPE, ncol = 4) +
coord_cartesian(ylim = yscale)
